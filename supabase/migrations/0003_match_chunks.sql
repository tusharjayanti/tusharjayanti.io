-- match_chunks: v1 cosine-similarity retrieval over the `chunks`
-- table. Filters by `source` (so a query can be scoped to
...
--
-- A later migration extends this in place via a new `create or
-- replace` to add hybrid (BM25 + dense) scoring.
