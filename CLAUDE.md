...
- Wiring: `/api/chat` does NOT call retrieval yet. Tool-use integration is M2.4. M2.1-M2.2 are reachable via the smoke script, integration tests, and direct RPC only.
